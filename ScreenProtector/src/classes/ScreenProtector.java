...
public class ScreenProtector extends javax.swing.JFrame implements Runnable{
	...
	private static final classes.Elipse New = null;
	// tamanho da tela
	...
	public void run() {
		...
		//instância e toca efeito sonoro (em loop infinito) 
	...
	Image santos = new Image("/images/Santos.png", 100, 100);
	santos.scale(0.5);
	Image batman = new Image("/images/batman.png", 50, 100, "/sounds/impact.wav", false);
	batman.scale(0.7);
		...
		while(true) {
			...
			batman.getCollision(getWidth(), getHeight());
